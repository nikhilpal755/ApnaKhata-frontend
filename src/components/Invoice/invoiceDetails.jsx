...
const InvoiceDetails = () => {
    ...
    const downLoadClick = () => {
        ...
        axios.post(`https://apna-khata-10.vercel.app/create-pdf`, {
        ...
        }).then(() => axios.get('https://apna-khata-10.vercel.app/get-pdf', { responseType: 'blob' }))
            .then((res) => {
    ...
    const sendInvoice = () => {
        ...
        axios.post('https://apna-khata-10.vercel.app/send-pdf', {
            name: invoice?.client?.name,
            address: invoice?.client?.address,
